...
def createImage(path):
	...
	for i in range(0, 21):
		# vertical lines from upper left to lower left
		start = convertCoordinates(str(-2000 + i*100) + ' ' + str(-2000))
		end = convertCoordinates(str(-2000 + i*100) + ' ' + str(2000))
		draw.line((start, end), fill=(250,0,0), width=3) if i % 5 == 0 else draw.line((start, end), fill=(220,0,0))
		draw.line((start, end), fill=(250,250,250), width=3) if i == 20 else None
		draw.text((start[0], start[1]-20) , str(-2000 + i*100), fill=(255,255,255), font=font)
		draw.text((end[0], end[1]+8) , str(-2000 + i*100), fill=(255,255,255), font=font)
		# vertical lines from upper right to lower right
		start = convertCoordinates(str(2000 - i*100) + ' ' + str(-2000))
		end = convertCoordinates(str(2000 - i*100) + ' ' + str(2000))
		draw.line((start, end), fill=(220,0,0), width=3) if i % 5 == 0 else draw.line((start, end), fill=(220,0,0))
		draw.line((start, end), fill=(250,250,250), width=3) if i == 20 else None
		draw.text((start[0], start[1]-20) , str(2000 - i*100), fill=(255,255,255), font=font)
		draw.text((end[0], end[1]+8) , str(2000 - i*100), fill=(255,255,255), font=font)
		# horizontal lines from upper left to upper right
		start = convertCoordinates(str(-2000) + ' ' + str(-2000 + i*100))
		end = convertCoordinates(str(2000) + ' ' + str(-2000 + i*100))
		draw.line((start, end), fill=(220,0,0), width=3) if i % 5 == 0 else draw.line((start, end), fill=(220,0,0))
		draw.line((start, end), fill=(250,250,250), width=3) if i == 20 else None
		draw.text((start[0]-35, start[1]-7) , str(-2000 + i*100), fill=(255,255,255), font=font)
		draw.text((end[0]+8, end[1]-7) , str(-2000 + i*100), fill=(255,255,255), font=font)
		# horizontal lines from lower left to lower right
		start = convertCoordinates(str(-2000) + ' ' + str(2000 - i*100))
		end = convertCoordinates(str(2000) + ' ' + str(2000 - i*100))
		draw.line((start, end), fill=(220,0,0), width=3) if i % 5 == 0 else draw.line((start, end), fill=(220,0,0))
		draw.line((start, end), fill=(250,250,250), width=3) if i == 20 else None
