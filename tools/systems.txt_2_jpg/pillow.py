...
def setVar():
	...
	global governments
	global govColor
	dataFolder = '/storage/9C33-6BBD/endless sky/data_0.10.2/' # change to your data folder
	...
	legend = ['Republic', 'Syndicate', 'Pirate', 'Remnant', 'Hai', 'Hai (Unfettered)', 'Quarg', 'Pug', 'Coalition', 'Heliarch', 
		'Korath Exiles', 'Kor Efret', 'Kor Mereti', 'Kor Sestor', 'Wanderer', 'Bunrodea', 'Gegno', 'Gegno Scin', 'Gegno Vi'] # show these governments
	systemNames = []
	systemPosX = []
	systemPosY = []
	systemFactions = []
...
def colorConvert(colInput): # formatfrom rgb 1 to: rgb(255,255,255)
